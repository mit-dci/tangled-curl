...
# This file if a modified version of the Curl-P code made avaliable under the MIT License @ https://github.com/iotaledger/iota.lib.py 
# it is slightly out of date
...
class Curl(object):
  ...
  **IMPORTANT: Not thread-safe!**
  ...
  def _transform(self, rounds = NUMBER_OF_ROUNDS):
    # type: () -> None
    """
